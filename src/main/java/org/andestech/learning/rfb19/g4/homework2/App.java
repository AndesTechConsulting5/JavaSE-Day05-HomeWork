...
public class App 
{
    public static void main( String[] args ) {
        ...
        DebitAccount customer69DebitAccount = new DebitAccount(customer69, 3000, 1);
        ...
        System.out.println(customer69CreditAccount.getBalance());
        customer69CreditAccount.withdrawal(10000.01);


        System.out.println(customer69DebitAccount.getBalance());
        customer69DebitAccount.putMoney(100_000.01);
        customer69DebitAccount.withdrawal(9000);
